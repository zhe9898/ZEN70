...
from sqlalchemy import Boolean, DateTime, Enum, String, Text, ARRAY, Index
...
class Asset(Base):
    ...
    __table_args__ = (
        ...
        Index('ix_asset_embedding', embedding, postgresql_using='ivfflat', postgresql_with={'lists': 100}, postgresql_ops={'embedding': 'vector_cosine_ops'}),
    )
