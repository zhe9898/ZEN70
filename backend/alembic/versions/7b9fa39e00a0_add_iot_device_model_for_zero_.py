...
def upgrade() -> None:
    ...
    op.bulk_insert(device_table, [
        {"id": "light_living_1", "type": "light", "name": "客厅主灯", "icon": "💡", "room": "客厅"},
        {"id": "light_bedroom_1", "type": "light", "name": "卧室床头灯", "icon": "🛏️", "room": "卧室"},
        {"id": "sensor_temp_1", "type": "sensor", "name": "婴儿房温湿度", "icon": "🌡️", "room": "婴儿房"},
        {"id": "curtain_1", "type": "curtain", "name": "落地窗帘", "icon": "🪟", "room": "客厅"},
    ])
